...
public class TC003_Dress_Summer_Dresses_Shopping extends Baseclass {
...
{
	log.info("@@@ TC003_Women_Summer Dresses_Shopping pre set up started @@@");
  ...
  public void shopping()
  {
	  ...
	  log.info("*** TC003_Women_Summer Dresses_Shopping started with IE browsr opening ***");
	  ...
	  new HomePage(driver).clickDress("Dress", "Summer Dress");	  
  }
  
  @AfterClass
  public void closeTetcase() throws IOException
  {
  	log.info("@@@ TC003_Women_Summer Dresses_Shopping test case closed @@@");
  	props=null;
  	fis=null;
  	//driver.close();
  }
